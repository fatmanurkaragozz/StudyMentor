...
- **Duolingo veri seti için gelecek planı**: Bu veri seti (kelime bazlı, gerçek dil öğrenimi verisi) StudyMentor'a ileride eklenebilecek bir **İngilizce kelime kartı (flashcard)** özelliği için referans olabilir. Non-commercial araştırma lisansı taşıdığı için repoda tutulmuyor; nereden indirileceği [`ml-service/fixtures/README.md`](../ml-service/fixtures/README.md) içinde.
